...
namespace FirmwarePacking.Repositories
{
    ...
    /// <remarks>Класс, оборачивающий уже находящийся в памяти <see cref="FirmwarePackage" />, реализуя интерфейс
    ///     <see cref="IRepositoryElement" />, делегируя вызовы напрямую пакету, переданному в аргументах конструктора</remarks>
    public class MemoryRepositoryElement : IRepositoryElement
    {
        ...
        {
            get { return _package.Information; }
        }
        ...
        public FirmwarePackage GetPackage() { return _package; }
        ...
        public FirmwareComponent GetComponent(ComponentTarget Target) { return _package.Components.Single(c => c.Targets.Contains(Target)); }
    }
}
